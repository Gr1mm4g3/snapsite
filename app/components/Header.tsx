          ...
          <Link href="/" className="flex items-center space-x-2 group">
            <div className="flex items-center">
              ...
              <span className="ml-2 text-2xl font-bold text-cyan-500">
                Snap<span className="text-magenta-500">site</span>
              </span>
            ...
            <div className="flex items-center space-x-4 ml-4">
              ...
              <SignedOut>
                <SignInButton mode="modal">
                  <button className="text-sm font-medium text-foreground/80">
                    Sign in
                  </button>
                </SignInButton>
                <SignUpButton mode="modal">
                  <button className="bg-cyan-500 text-white px-4 py-2 rounded-md text-sm font-medium hover:bg-magenta-500 transition-colors">
                    Get started
                  </button>
                </SignUpButton>
              </SignedOut>
